        ...
        >
            ...
            <div className="container mx-auto py-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 flex justify-center">
                    <div className="block w-full p-8 bg-white border border-gray-200 rounded-lg shadow hover:bg-white dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                        <h2 className="mt-2 text-lg font-semibold text-gray-900 dark:text-white">
                            Add Reviewer
                        </h2>
                        <p className="mt-1 text-sm">Add Your Preferred Reviewer from Here</p>
